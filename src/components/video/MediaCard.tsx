  ...
  return (
    <article
      className={`group overflow-hidden rounded-2xl border ${
        isFailed ? "border-[#7f2d2d]/70 bg-[#2a1012]" : "border-[#33323a]/60 bg-[#111318]/70"
      }`}
    >
      <div className="relative grid aspect-video place-items-center overflow-hidden bg-[#1a1c22]">
        ...
        <span className="absolute left-2 top-2 rounded-full border border-[#33323a]/65 bg-[#05070b]/62 px-2 py-1 text-[10px] font-black uppercase tracking-[.12em] text-[#f4f4f4]/72 backdrop-blur">
      ...
      <div className={compact ? "grid gap-1.5 p-2" : "grid gap-2 p-3"}>
        <div className="min-w-0">
          ...
          <p className={`mt-1 text-[11px] font-black uppercase tracking-[.12em] ${isFailed ? "text-red-100/75" : "text-[#b9b9b9]/45"}`}>
        ...
        <div className="flex flex-wrap gap-2">
          {item.url ? (
            <a
              className="rounded-full border border-[#33323a]/60 px-2 py-1 text-[11px] font-bold text-[#b9b9b9]/60 transition hover:border-[#ffb44d]/40 hover:text-[#ffb44d]"
              href={item.url}
              rel="noreferrer"
              target="_blank"
            >
          ...
          <button
            className="rounded-full border border-[#33323a]/60 px-2 py-1 text-[11px] font-bold text-[#b9b9b9]/60 transition hover:border-[#7f2d2d]/70 hover:text-red-100"
