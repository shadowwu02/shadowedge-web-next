...
export function normalizeVideoHistoryItem(item: unknown): VideoHistoryItem {
  ...
  return {
    ...
    resultAssetId: pickString(record.resultAssetId, record.result_asset_id, meta.resultAssetId, meta.materializedAssetId),
    privateCanonicalResult: record.privateCanonicalResult === true || meta.privateCanonicalResult === true,
    playbackExpiresAt: pickString(record.playbackExpiresAt, record.playback_expires_at),
