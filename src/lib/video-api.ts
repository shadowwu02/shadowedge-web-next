...
export function normalizeVideoHistoryItem(item: unknown): VideoHistoryItem {
  ...
  return {
    ...
    mediaList,
    error_message: pickString(record.error_message, record.errorMessage, record.error, meta.providerPublicMessage, meta.provider_public_message, meta.error_message, meta.errorMessage),
    errorCode: pickString(record.error_code, record.errorCode, meta.error_code, meta.errorCode),
    providerPublicMessage: pickString(record.providerPublicMessage, record.provider_public_message, meta.providerPublicMessage, meta.provider_public_message),
    providerPublicMessageEn: pickString(record.providerPublicMessageEn, record.provider_public_message_en, meta.providerPublicMessageEn, meta.provider_public_message_en),
    providerPublicMessageZh: pickString(record.providerPublicMessageZh, record.provider_public_message_zh, meta.providerPublicMessageZh, meta.provider_public_message_zh),
    providerFailureCategory: pickString(record.providerFailureCategory, record.provider_failure_category, meta.providerFailureCategory, meta.provider_failure_category),
