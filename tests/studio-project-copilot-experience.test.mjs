...
test("Project Copilot schema exposes the bounded suggestion types", () => {
  assert.deepEqual(STUDIO_COPILOT_SUGGESTION_TYPES, ["NEXT_STEP", "STYLE_IMPROVEMENT", "WORKFLOW_SUGGESTION", "COST_WARNING", "QUALITY_WARNING", "STRATEGY_PROPOSAL", "FUTURE_PLAN_PROPOSAL", "GOAL_ALIGNMENT_REVIEW", "PORTFOLIO_PRIORITY_SUGGESTION", "RESOURCE_REUSE_SUGGESTION", "PRODUCTION_EFFICIENCY_SUGGESTION", "CREATIVE_QUALITY_SUGGESTION", "CREATIVE_OPTIMIZATION_SUGGESTION"]);
  assert.equal(studioCopilotSuggestionLabel("WORKFLOW_SUGGESTION"), "Workflow suggestion");
  assert.deepEqual(STUDIO_COPILOT_ACTION_TYPES, ["CREATE_DRAFT", "IMPROVE_PLAN", "REVIEW_WORKFLOW", "CHECK_COST", "CHECK_QUALITY", "REVIEW_STRATEGY", "REVIEW_FUTURE_PLAN", "REVIEW_GOALS", "REVIEW_PORTFOLIO", "REVIEW_ASSET_REUSE", "REVIEW_EFFICIENCY", "REVIEW_CREATIVE_QUALITY", "REVIEW_OPTIMIZATION"]);
  assert.deepEqual(STUDIO_COPILOT_DRAFT_TYPES, ["CHARACTER_DRAFT", "STORYBOARD_DRAFT", "WORKFLOW_DRAFT", "PROMPT_DRAFT", "STRATEGY_DRAFT", "FUTURE_PLAN_DRAFT", "GOAL_REVIEW_DRAFT", "PORTFOLIO_STRATEGY_DRAFT", "ASSET_REUSE_DRAFT", "EFFICIENCY_OPTIMIZATION_DRAFT", "QUALITY_IMPROVEMENT_DRAFT", "OPTIMIZATION_DRAFT"]);
